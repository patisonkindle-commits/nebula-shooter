// v2 BulletManager — faithful ESM port of v1 (JS/entities/Bullet.js)
// Two sub-pools + burst callback. Signatures match v1 exactly for Game parity.

import { Pool } from '../core/Pool.js';
import { CONFIG } from '../core/config.js';
import { clamp, dist, angleDiff } from '../core/utils.js';
    ...
    this.playerBullets.updateAll(dt, (b) => {
      ...
      if (cx < -20 || cx > W + 20 || cy < -20 || cy > H + 20) {
        if (b.ricochet && b.ricochetRemaining > 0) {
          if (cx < -20 || cx > W + 20) {
            b.vx = -b.vx;
            if (b.wave) b.waveAngle = Math.atan2(b.vy, b.vx);
          }
          if (cy < -20) {
            b.vy = -b.vy;
            if (b.wave) b.waveAngle = Math.atan2(b.vy, b.vx);
