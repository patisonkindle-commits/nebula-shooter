// Main menu screen — neon glow, animated ship, tap-to-start
// v2: ES module, ports v1 MenuScreen visuals + interactions.
...
class MenuScreen {
  ...
  render(ctx, meta) {
    ...
    ctx.fillText('v2.0  •  procedural audio  •  canvas', CONFIG.WIDTH / 2, CONFIG.HEIGHT - 6);
